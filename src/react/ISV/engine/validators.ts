...
/**
 * Veeam VBO validator (with capacity and application)
 */
export const VeeamVBOValidator = Joi.object({
  ...
  application: Joi.string()
    .valid('VEEAM_OFFICE_365_V7', 'VEEAM_OFFICE_365_V8')
    .required(),
});
...
/**
 * Create a custom validator by extending a base validator
 */
export function extendValidator(
  base: Joi.ObjectSchema,
  extensions: Record<string, Joi.Schema>
): Joi.ObjectSchema {
  return base.keys(extensions);
}
