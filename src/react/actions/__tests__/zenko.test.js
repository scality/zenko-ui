...
describe('zenko actions', () => {
    ...
    const syncTests = [
        ...
        },
        {
            ...
            expectedActions: [dispatchAction.ZENKO_CLIENT_WRITE_SEARCH_LIST_ACTION(null, LIST)],
        },
        {
        ...
        },
        {
            ...
            expectedActions: [dispatchAction.ZENKO_CLIENT_APPEND_SEARCH_LIST_ACTION(null, LIST)],
        },
    ];
