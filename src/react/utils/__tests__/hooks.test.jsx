...
const fireResizeEvent = (x, y) => {
    Object.defineProperty(HTMLElement.prototype, 'offsetHeight', { configurable: true, value: y });
    Object.defineProperty(HTMLElement.prototype, 'offsetWidth', { configurable: true, value: x });
...
describe('hooks', () => {
    ...
    it('should trigger if a click occurs outside the component', async () => {
        const useOutsideClickMock = jest.spyOn(hooks, 'useOutsideClick').mockImplementation(() => {});
