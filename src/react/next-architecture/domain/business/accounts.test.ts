...
describe('useAccountLatestUsedCapacity', () => {
  ...
  it('should not be executed if the account metrics has been retrieved', () => {
    //S
    const metricsAdapter = new MockedMetricsAdapter();
    const accountsAdapter = new MockedAccountsAdapter();
    //E
  ...
  it('should update the account `usedcapacity` after retrieving the account metrics', () => {
    //S
    const metricsAdapter = new MockedMetricsAdapter();
    const accountsAdapter = new MockedAccountsAdapter();
    //E
    ...
    //V
    expect(result.current.accounts.status).toBe('success');
    expect(
      //@ts-ignore
