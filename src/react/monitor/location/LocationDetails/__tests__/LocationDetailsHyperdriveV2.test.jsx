...
describe('class <LocationDetailsHyperdriveV2 />', () => {
    ...
    it('should show empty bootstrap list', () => {
        const component = mount(
            <LocationDetailsHyperdriveV2 {...props} />
        );
    ...
    it('should show three items in the bootstrap list', () => {
        ...
        expect(component.find('InputList').props().entries).toEqual(['localhost:83', 'localhost:84', 'localhost:85']);
    });

    it('should disable add button if ten items in the bootstrap list', () => {
        const bootstrapList = ['localhost:80', 'localhost:81', 'localhost:82',
            'localhost:83', 'localhost:84', 'localhost:85',
            'localhost:86', 'localhost:87', 'localhost:88', 'localhost:89'];
        const locationDetails = {
            bootstrapList,
        };
        const component = mount(
    ...
    it('should add entry and save hyperdrive location details', () => {
        ...
        const component = mount(
            <LocationDetailsHyperdriveV2 {...props} details={location} onChange={l => location = l} />
        );
