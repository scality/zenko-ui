...
describe('Properties', () => {
    it('should render Properties component', async () => {
    ...
    it('should render Properties component with rows', () => {
    ...
    it('should render Properties component with no version ID', () => {
        const objectMetadata = { ...OBJECT_METADATA, versionId: undefined };
        const { component } = reduxMount(<Properties objectMetadata={objectMetadata} />);
