...
describe('ObjectUpload', () => {
    const closeObjectUploadModalMock = jest.spyOn(s3object, 'closeObjectUploadModal');
    ...
    it('should render ObjectUpload component', () => {
        const { component } = reduxMount(<ObjectUpload bucketName={BUCKET_NAME} prefixWithSlash=''/>, {
            uiObjects: {
    ...
    tests.forEach((t, index) => {
        it(t, async () => {
            ...
            case 2:
                ...
                expect(component.find('td').at(0).find('small').text()).toBe('4 Bytes');
