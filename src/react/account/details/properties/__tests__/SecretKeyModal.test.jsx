...
describe('SecretKeyModal', () => {
    ...
    it('should render SecretKeyModal component with key informations', () => {
        ...
        testRow(firstRow, { key: 'Account name', value: accountKey.accountName });

        const secondRow = rows.at(1);
        testRow(secondRow, { key: 'Access key ID', value: accountKey.accessKey, extraCellComponent: 'Clipboard' });

        const thirdRow = rows.at(2);
        testRow(thirdRow, { key: 'Secret Access key', value: hiddenValue, extraCellComponent: 'Clipboard' });
    });
});
