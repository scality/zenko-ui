...
export default class LocationDetailsDOSpaces extends React.Component<LocationDetailsFormProps, State> {
  ...
  shouldComponentUpdate(_nextProps: LocationDetailsFormProps, nextState: State) {
