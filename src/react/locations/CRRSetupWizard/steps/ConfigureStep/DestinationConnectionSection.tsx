...
const ConstrainedInput = styled(Input)`
  max-width: 22rem;
  /* The 100% max-width this replaces also let the input shrink to its 151px size-attribute
     floor; min-width: 0 keeps that, so it stops it spilling out of the field cell. */
  min-width: 0;
`;
