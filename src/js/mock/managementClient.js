...
export const location2: Location = {
    name: 'location2',
    locationType: toLocationType('location-scality-ring-s3-v1'),
    details: {},
    objectId: 'object-id',
    isBuiltin: false,
    isTransient: false,
...
export const workflows: Workflows = [{
    id: 'replication-id',
    bucketName: replicationWorkflow.source.bucketName,
    type: 'replication',
    name: replicationWorkflow.name,
    state: replicationWorkflow.enabled,
    workflowId: replicationWorkflow.streamId,
}];
