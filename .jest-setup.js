...
// Deliberately no ResizeObserver mock: jsdom performs no layout, so any mock could only report
// a 0px box, which core-ui's container-width hook would read as a real narrow container and
// collapse every `dropAt`/`iconOnly`. Absent, the hook reads the width as unknown and renders
// the wide layout.
